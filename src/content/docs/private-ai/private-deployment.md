...
![Private deployment: the AI workspace runs inside the client's own cloud or on-premise, with audit logs, role-based access and policy controls (illustrative).](/images/deployment.svg)
_The workspace runs inside the client's perimeter. Audit logs, role-based access and policy controls sit around it (illustrative)._
